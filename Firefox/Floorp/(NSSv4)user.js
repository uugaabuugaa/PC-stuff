...
user_pref("general.smoothScroll.msdPhysics.slowdownSpringConstant",      3000);//NSS   [2000]
user_pref("general.smoothScroll.currentVelocityWeighting",             "0.12");//NSS ["0.25"]
user_pref("general.smoothScroll.stopDecelerationWeighting",            "0.3");//NSS  ["0.4"]
...
user_pref("mousewheel.acceleration.start",                                -2);//NSS     [-1]
